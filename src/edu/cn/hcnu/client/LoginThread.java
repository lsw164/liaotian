...
public class LoginThread extends Thread {
    ...
    public void run() {
        ...
        t = new JTextField("Version " + "1.1.0" + "        By lsw");
        ...
        final JTextField loginname = new JTextField("lsw");
        ...
        final JTextField loginPassword = new JTextField("lsw888");
        ...
        class ButtonListener implements ActionListener {
            ...
            public void actionPerformed(ActionEvent e) {
				...
				/*
				1、根据用户去数据库把加密后的密码拿到
				SELECT password FROM users WHERE username='lsw';
